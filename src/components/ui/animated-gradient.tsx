...
/**
 * Retina screens on phones push the fragment shader far harder than the visual
 * gain is worth, so the backing store is capped rather than tracking
 * devicePixelRatio exactly.
 */
